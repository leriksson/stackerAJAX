...
var showAnswerer = function(answerer) {
	...
	// Set the question properties in result
	var answererElem = result.find('.answerer-image a');
	...
	var answererImageElem = result.find('.image a');
	answererImageElem.attr('href', answerer.user.link);
	// var date = new Date(1000*question.creation_date);
	// asked.text(date.toString());   profile_image
